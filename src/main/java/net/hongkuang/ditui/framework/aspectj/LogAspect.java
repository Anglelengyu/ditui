package net.hongkuang.ditui.framework.aspectj;
...
import net.hongkuang.ditui.framework.aspectj.lang.enums.BusinessStatus;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(net.hongkuang.ditui.framework.aspectj.lang.annotation.Log)")
