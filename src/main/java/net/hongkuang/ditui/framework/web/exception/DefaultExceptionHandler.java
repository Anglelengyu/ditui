package net.hongkuang.ditui.framework.web.exception;
...
import net.hongkuang.ditui.common.exception.DemoModeException;
import net.hongkuang.ditui.common.exception.TokenCheckException;
import net.hongkuang.ditui.common.utils.security.PermissionUtils;
...
public class DefaultExceptionHandler {
    ...
    public AjaxResult businessException(BusinessDataException e) {
        log.error(e.getMessage(), e);
        return AjaxResult.error(e.getCode(), e.getMessage()).put("data", e.getData());
    }
    ...
    public AjaxResult tokenCheckException(TokenCheckException e) {
        log.error(e.getMessage(), e);
