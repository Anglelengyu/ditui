...
public class UserConstants {
     ...
     * 模版名称是否唯一的返回结果码
     */
    public final static String TEMPLATE_NAME_UNIQUE = "0";
    public final static String TEMPLATE_NAME_NOT_UNIQUE = "1";
    ...
    public static class UserRoles {
        ...
        public static final String ROLE_SHOP_REFER = "shop_refer";
        public static final String ROLE_GROUP_LEADER = "group_leader";
        //团队角色
        public static final String ROLE_TEAM = "team";
        //线上员工角色
        public static final String ROLE_ONLINE_EMPLOYEE = "online_employee";
        //地推员工角色
        public static final String ROLE_GROUND_EMPLOYEE = "ground_employee";
    }

    public static class buildInviterUrl {
        private HttpServletRequest request;

        public buildInviterUrl(HttpServletRequest request) {
        ...
        public String build() {
            try {
                ...
                String url = request.getScheme() + "://" + ShiroUtils.getIp() + "/register/" +
                        (user == null || StringUtils.isBlank(user.getUserNum()) ? "null" : user.getUserNum());
                return UriComponentsBuilder.fromHttpUrl(URLDecoder.decode(url, "utf-8")).build().toUriString();
