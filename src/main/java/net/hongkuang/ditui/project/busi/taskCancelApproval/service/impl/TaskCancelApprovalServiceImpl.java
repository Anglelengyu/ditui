package net.hongkuang.ditui.project.busi.taskCancelApproval.service.impl;
 ...
 */
@Service
public class TaskCancelApprovalServiceImpl implements ITaskCancelApprovalService {
    @Autowired
     ...
     */
    @Override
    public TaskCancelApproval selectTaskCancelApprovalById(Integer id) {
        return taskCancelApprovalMapper.selectTaskCancelApprovalById(id);
    }
     ...
     */
    @Override
    public List<TaskCancelApproval> selectTaskCancelApprovalList(TaskCancelApproval taskCancelApproval) {
        return taskCancelApprovalMapper.selectTaskCancelApprovalList(taskCancelApproval);
    }
     ...
     */
    @Override
    public int insertTaskCancelApproval(TaskCancelApproval taskCancelApproval) {
        return taskCancelApprovalMapper.insertTaskCancelApproval(taskCancelApproval);
    }
     ...
     */
    @Override
    public int updateTaskCancelApproval(TaskCancelApproval taskCancelApproval) {
        return taskCancelApprovalMapper.updateTaskCancelApproval(taskCancelApproval);
    }
     ...
     */
    @Override
    public int deleteTaskCancelApprovalByIds(String ids) {
        return taskCancelApprovalMapper.deleteTaskCancelApprovalByIds(Convert.toStrArray(ids));
    }
    ...
    public int pass(String id) {
        String[] ids = id.split(",");
        int count = taskCancelApprovalMapper.pass(ids);
        List<String> taskIds = taskCancelApprovalMapper.selectTaskIdsByIds(ids);
...
//        int scount = saleOrderMapper.updateSaleOrderStatusByTaskId(taskId);
    ...
    public int reject(String id) {
        ...
        List<String> ids = taskCancelApprovalMapper.getTaskIdsById(idStr);
        int count = taskCancelApprovalMapper.reject(idStr);
        // 修改状态
        int result = 0;
        try {
