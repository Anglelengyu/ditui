package net.hongkuang.ditui.project.busi.groundTaskCancelApproval.domain;
...
/**
 * 任务取消审批表 busi_ground_task_cancel_approval
 *
 * @author:zy
 * @date: 2019/4/22
 */
public class GroundTaskCancelApproval extends BaseEntity {
    ...
    public String toString() {
        return "GroundTaskCancelApproval{" +
                "id=" + id +
