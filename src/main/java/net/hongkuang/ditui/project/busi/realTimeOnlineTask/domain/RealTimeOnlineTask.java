package net.hongkuang.ditui.project.busi.realTimeOnlineTask.domain;
...
/**
 * 实时任务表 busi_real_time_online_task
 *
 * @author:zy
 * @date: 2019/4/18
 */
public class RealTimeOnlineTask extends BaseEntity {
    ...
    public RealTimeOnlineTask() {

    }

    public RealTimeOnlineTask(RealTimeOnlineSetting realTimeOnlineSetting, OnlineTask onlineTask) {
        this.startTime = realTimeOnlineSetting.getStartTimeNode();
        this.stopTime = realTimeOnlineSetting.getStopTimeNode();
        this.taskDate = realTimeOnlineSetting.getTaskDate();
        this.orLock = realTimeOnlineSetting.getOrLock();
        this.status = RealTimeTaskStatus.DISRUSH.getCode();
        this.taskId = onlineTask.getTaskId();
    }
