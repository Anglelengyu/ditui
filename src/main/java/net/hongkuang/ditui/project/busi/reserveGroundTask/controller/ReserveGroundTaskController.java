package net.hongkuang.ditui.project.busi.reserveGroundTask.controller;
 ...
 */
@Controller
@RequestMapping("/busi/reserveGroundTask")
public class ReserveGroundTaskController extends BaseController {
    private String prefix = "busi/reserveGroundTask";

    @Autowired
    private IReserveGroundTaskService reserveTaskService;
    ...
    @PostMapping("/list")
    @ResponseBody
    public TableDataInfo list(ReserveGroundTask reserveTask) {
        startPage();
        List<ReserveGroundTask> list = reserveTaskService.selectReserveTaskList(reserveTask);
    ...
    @PostMapping("/export")
    @ResponseBody
    public AjaxResult export(ReserveGroundTask reserveTask) {
        List<ReserveGroundTask> list = reserveTaskService.selectReserveTaskList(reserveTask);
        ExcelUtil<ReserveGroundTask> util = new ExcelUtil<ReserveGroundTask>(ReserveGroundTask.class);
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(ReserveGroundTask reserveTask) {
    ...
    public String edit(@PathVariable("id") Long id, ModelMap mmap) {
        ReserveGroundTask reserveTask = reserveTaskService.selectReserveTaskById(id);
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(ReserveGroundTask reserveTask) {
