package net.hongkuang.ditui.project.busi.realTimeOnlineSetting.domain;
...
/**
 * 实时任务时间设置表 busi_real_time_online_setting
 *
 * @author:zy
 * @date: 2019/4/18
 */
public class RealTimeOnlineSetting extends BaseEntity {
