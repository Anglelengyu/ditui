package net.hongkuang.ditui.project.system.config.service.impl;

import java.util.List;

import net.hongkuang.ditui.project.system.config.service.IConfigService;
...
import net.hongkuang.ditui.project.system.config.domain.Config;
import net.hongkuang.ditui.project.system.config.mapper.ConfigMapper;
