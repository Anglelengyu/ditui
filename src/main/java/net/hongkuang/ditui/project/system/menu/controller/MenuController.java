package net.hongkuang.ditui.project.system.menu.controller;
...
public class MenuController extends BaseController {
     ...
     * 加载角色菜单列表树
     */
    @GetMapping("/roleUserMenuTreeData")
    @ResponseBody
    public List<Map<String, Object>> roleUserMenuTreeData() {
        List<Role> roleList = roleService.selectCheckRolesByUserId(ShiroUtils.getUserId());
        List<Map<String, Object>> tree = menuService.userRoleMenuTreeData(roleList, ShiroUtils.getUserId());
        return tree;
    }
}