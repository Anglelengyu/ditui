package net.hongkuang.ditui.project.userCenter.coinsConsumptionLog.mapper;
 ...
 * @date 2019-04-17
 */
public interface CoinsConsumptionLogMapper {
    /**
     * 查询充值扣费记录信息
     *
     * @param id 充值扣费记录ID
     ...
     * @return 结果
     */
    public int deleteCoinsConsumptionLogById(Integer id);
